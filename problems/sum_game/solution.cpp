...
This is a nice brain teaser / game theory / greedy / math problem.
We can solve it by analyzing 3 possible cases.
...
(a.) (before the last turn) left sum == right sum;
...
(b.) (before the last turn) left sum != right sum;
(during the last turn) Alice takes the last turn and replaces the last '?'
