...
public:
    vector<string> removeComments(vector<string>& source) {
        vector<string> ans;
        string s;  // if you initialise string s everytime for every line, you will miss the buffer text that is present before line having multi line comment , see second tc
        bool comment = false;
