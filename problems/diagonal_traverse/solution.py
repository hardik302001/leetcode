# 1.  brute force, iterate first row as starting of diagonals, then last colum for starting of diagonals
#     then alternately reverse and append

# 2. simulation (see editorial)

# 3. most OP soln, see below, we use map to keep track of elemnts on diagonal
